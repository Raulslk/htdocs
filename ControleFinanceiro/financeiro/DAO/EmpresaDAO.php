<?php
    ...
    class EmpresaDAO extends Conexao{
        ...
        public function AlterarEmpresa($nomeEmpt, $telefone, $endereco, $idEmpresa){
            if($nomeEmpt == '' || $telefone == '' || $endereco == '' || $idEmpresa == ''){
                return 0;
            }else{
                $conexao = parent::retornarConexao();
